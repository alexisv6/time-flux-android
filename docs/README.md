...
|---|---|---|---|---|
| 001 | Module registry + navigation | [spec](specs/001-module-registry-and-navigation.md) | [plan](plans/001-module-registry-and-navigation.md) | In progress — phases 1–5 of 7 |
